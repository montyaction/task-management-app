...
export default function UserAvatar({ user, className = "", sizeClass = "h-10 w-10", textClass = "text-sm" }) {
  ...
  return (
    <div
      className={`inline-flex items-center justify-center overflow-hidden rounded-full border border-white/80 bg-gradient-to-br from-slate-100 to-slate-200 font-semibold text-slate-700 shadow-sm dark:border-slate-700 dark:from-slate-700 dark:to-slate-800 dark:text-slate-200 ${sizeClass} ${textClass} ${className}`}
